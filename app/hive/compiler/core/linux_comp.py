...
class LinuxPythonCompilerCore:
    ...
    def exec_cmd(self, command: str) -> object:
        ...
        for line in output:
            self.msg("msg", line.decode().strip())
    ...
    def build_lab(self) -> None:
        self.msg("msg", "[!!] Start of laboratory construction .... [!!]")
        self.compiler.start()
        sleep(1)
        self.update_repo()
    ...
    def compile_worm(self, worm_pipeline: object) -> object:
        ...
        match comp:
            ...
            case _:
                self.msg("error", f"ERROR: No compiler: '{comp}'.")
        return worm_pipeline
